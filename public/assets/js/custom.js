...
// Point-to-point: bind every form (mobile + desktop). Do not require client-side
// Google Geocoder success — on production, JS API key referrer restrictions often
// block Geocoder while localhost works, which prevented POST entirely.
